...
//			T.LookAt(0, 0, 0, 0, 0, -100, 0, 1, 0);  	//Default
			...
			//position below cone
			T.translate(0,-0.9f,0);
			gl.glUniformMatrix4fv( ModelView, 1, true, T.getTransformv(), 0 );
			gl.glUniformMatrix4fv( NormalTransform, 1, true, T.getInvTransformTv(), 0 );

			//set uniform variables to shader for cone
		...
		public void init(GLAutoDrawable drawable) {
			...
			//new cone object
			SObject cone = new SCone(1,20,2);
			idPoint=1;
			idBuffer=1;
			idElement=1;
			createObject(gl, cone);

			// Set cone material 'Cyan Plastic' different from sphere
			Vec4 materialAmbient2 = new Vec4(0.0f, 0.1f, 0.06f, 0.8f);
			Vec4 materialDiffuse2 = new Vec4(0.0f, 0.50980392f, 0.50980392f, 0.8f);
			Vec4 materialSpecular2 = new Vec4(0.50196078f, 0.50196078f, 0.50196078f, 0.8f);
			materialShininess2 = 0.25f;


			//set cone lighting properties
